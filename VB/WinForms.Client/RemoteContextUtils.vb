...
Namespace WinForms.Client
    ...
    Public Class RemoteContextUtils
        ...
        Public Shared Property Options As DbContextOptions(Of DataModel.Shared.BusinessObjects.DXApplication1EFCoreDbContext)
        ...
        Public Shared Function GetDBContext() As DXApplication1EFCoreDbContext
            Return New DataModel.[Shared].BusinessObjects.DXApplication1EFCoreDbContext(Options)
        End Function

        Public Shared Function CreateDbContextOptions(ByVal securedClient As WebApiSecuredDataServerClient) As DbContextOptions(Of DataModel.Shared.BusinessObjects.DXApplication1EFCoreDbContext)
            Dim builder = New DbContextOptionsBuilder(Of DataModel.[Shared].BusinessObjects.DXApplication1EFCoreDbContext)()
            Return TryCast(builder.UseLazyLoadingProxies().UseChangeTrackingProxies().UseMiddleTier(securedClient).Options, DbContextOptions(Of DataModel.[Shared].BusinessObjects.DXApplication1EFCoreDbContext))
        End Function
        ...
        Public Shared Function CreateSecuredClient(ByVal url As String, ByVal login As String, ByVal password As String) As WebApiSecuredDataServerClient
            ...
            AddHandler securedClient.CustomAuthenticate, Sub(sender, arguments)
                ...
                If msg.StatusCode Is HttpStatusCode.Unauthorized Then
